...
export class CheckoutComponent implements OnInit {
  ...
  payment(): void {
    if(
      ...
      this.checkoutService.showMessage('Please entern a valid data', false)
    } else {
      this.checkoutService.showMessage(`Payment is successfully, good choice!
      Confirmed order: to, ${this.client.address} by ${this.client.name}`, true)
